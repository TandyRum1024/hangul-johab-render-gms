///hj_draw_comp_sheet(kor_font_sprite, ascii_font_sprite, x, y, str, colour, alpha)
/*
...
for (var i=0; i<_strlen; i++)
{
    ...
    if (_curord <= global.hjComp_ASCII_LIMIT)
    {
        ...
        _v = (_idx div _asciicol) * _asciihei;
        draw_sprite_general(_asciispr, 0, _u, _v, _asciiwid, _asciihei, _offx, _offy, 1, 1, 0, _strcol, _strcol, _strcol, _strcol, _stralpha);
    ...
    else if (_curord >= $AC00 && _curord <= $D7AF) // 조합
    {
        ...
        _idx = _first + global.hjCompOffFirst + _rowlast + _rowmid * 2;
        _u = (_idx % 28) * global.hjCharWidHan;
        _v = (_idx div 28) * global.hjCharHeiHan;
        draw_sprite_general(_korspr, 0, _u, _v, global.hjCharWidHan, global.hjCharHeiHan, _offx, _offy, 1, 1, 0, _strcol, _strcol, _strcol, _strcol, _stralpha);
        
        _idx = _mid + global.hjCompOffMiddle + _rowmid;
        _u = (_idx % 28) * global.hjCharWidHan;
        _v = (_idx div 28) * global.hjCharHeiHan;
        draw_sprite_general(_korspr, 0, _u, _v, global.hjCharWidHan, global.hjCharHeiHan, _offx, _offy, 1, 1, 0, _strcol, _strcol, _strcol, _strcol, _stralpha);
        
        _idx = _last + global.hjCompOffLast + _rowlast;
        _u = (_idx % 28) * global.hjCharWidHan;
        _v = (_idx div 28) * global.hjCharHeiHan;
        draw_sprite_general(_korspr, 0, _u, _v, global.hjCharWidHan, global.hjCharHeiHan, _offx, _offy, 1, 1, 0, _strcol, _strcol, _strcol, _strcol, _stralpha);
    ...
    {
        _kr = _curord - $3130 + global.hjCompOffJamo;
