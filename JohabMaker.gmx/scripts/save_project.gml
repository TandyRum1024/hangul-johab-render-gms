...
surface_save(atlasTemp, working_directory + "/debug/atlas_mask_save.png");
...
surface_save(atlasTemp, working_directory + "/debug/atlas_baked_save.png");
...
buffer_write(_filebuffer, buffer_string, "JORT");
...
var _offsetoff = buffer_tell(_filebuffer);
buffer_write(_filebuffer, buffer_u32, 0); // write offsets later
